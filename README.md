...
- These are not Kubernetes specific but the bash shell. They however seem to be close friends with the K8s commands and would be nice to have very basic usage knowledge.
